...
public class UserListNameSortController implements Controller 
{
	private IDAO dao;
	...
	{
		System.out.println("UserListNameSortController 들어옴");
		...
		ArrayList<DTO> list= dao.UserListDesc(searchKey, searchValue);
