...
public class LastGameListController implements Controller
{
	private IDAO dao;
...
ModelAndView mav = new ModelAndView();
		...
		ArrayList<DTO> list= dao.selectUser(searchKey, searchValue);
		
		mav.addObject("list", list);
		mav.setViewName("/WEB-INF/views/LastGameList.jsp");
